class GameScene extends Phaser.Scene {
    ...
    onCardClicked(pointer, card) {
        ...
        card.open(() => {
            if (this.opendedCardsCount === this.cards.length / 2) {
    ...
    getCardPositions() {
        ...
        let offSetX = (this.game.config.width - cardWidth * config.cols) / 2 + cardWidth / 2 ;
        let offSetY = (this.game.config.height - cardHeight * config.rows) / 2 + cardHeight / 2 ;
